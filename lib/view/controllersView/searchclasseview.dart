...
class SearchClasseView extends StatefulWidget {
  const SearchClasseView({super.key,required this.search});
  final String search;
  @override
  State<SearchClasseView> createState() => _SearchClasseViewState();
}

class _SearchClasseViewState extends State<SearchClasseView> {
  ...
  enseignant = FirebaseFirestore.instance.collection('classes')
  .where('libelleclasse',isEqualTo: widget.search);
    return enseignant;
  }
