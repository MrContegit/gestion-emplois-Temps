...
class AppColor{
  ...
  static Color gradiantFirst=const Color(0xff0f17ad);
  static Color gradiantSecond=const Color(0xFF6985e8);
  ...
  static Color hommePageContainerTextSmall=const Color(0xFFf4f5fd);
  ...
  static Color homePagePlanColor=const Color(0xffa2a2b1);
   ...
   static Color secondPageContainerGradient2stColor=const Color(0xff0f17ad);
